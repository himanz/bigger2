...
Score.create(cards_left: 13, points: 4, hand_id: 1, player_id: 1)
Score.create(cards_left: 10, points: 3, hand_id: 1, player_id: 2)
Score.create(cards_left: 3, points: 1, hand_id: 1, player_id: 3)
